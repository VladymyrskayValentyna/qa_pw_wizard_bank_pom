...
test('Assert manager can Login', async ({ page }) => {
 ...
 await expect(managerPage.addCustomerButton).toBeVisible();
 await expect(managerPage.openAccountButton).toBeVisible();
 await expect(managerPage.customersButton).toBeVisible();
});
